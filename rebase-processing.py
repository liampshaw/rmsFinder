...
def searchHMM(query_protein_file, hmm_file):
    ...
    hmmsearch_command = ['hmmsearch', '--noali', '--tblout', 'tmp.out',
...
def prepREBASE(rebase_fasta, hmm_profile, hmm, dir):
    ...
    for fam in families:
        ...
        rebase_subset = extractHitsREBASE(rebase_fasta, hmm, hmm_search_results, family=fam)
        print(rebase_subset)
